...
namespace TwitterLib
{
    ...
    {
        public override StreamingMessageType MessageType => throw new NotImplementedException();

        public override Twitter Parent { get => throw new NotImplementedException(); internal set => throw new NotImplementedException(); }
    }
    /// <summary>
    /// ストリーミングメッセージに対する汎用デシリアライズクラスです。
    /// </summary>
    [DataContract]
