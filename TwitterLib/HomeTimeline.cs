...
namespace TwitterLib
{
    public partial class Twitter
    {
        ...
        public Tweet[] GetHomeTimeline(int? count = null, ulong? sinceId = null, ulong? maxId = null, bool? trimUser = null, bool? excludeReplies = null, bool? includeEntities = null)
        {
            ...
            return (Tweet[])GetOAuthResponce(TwitterAuthenticationMode.UserAuthentication, "GET", "https://api.twitter.com/1.1/statuses/home_timeline.json", args, typeof(Tweet[]));
        }
    }
}
