    ...
    public partial class Twitter
    {
        ...
        public IEnumerable<ulong> GetMuteIds(long? cursor = null)
        {
            ...
            do
            {
                ...
                IdContainer container = (IdContainer)GetOAuthResponce(TwitterAuthenticationMode.UserAuthentication, "GET", "https://api.twitter.com/1.1/mutes/users/ids.json", args, typeof(IdContainer));
        ...
        public IEnumerable<User> GetMuteUsers(bool? includeEntities = null, long? cursor = null)
        {
            ...
            do
            {
                if (cursor.HasValue)
                    args["cursor"] = cursor.ToString();
                UserContainer container = (UserContainer)GetOAuthResponce(TwitterAuthenticationMode.UserAuthentication, "GET", "https://api.twitter.com/1.1/mutes/users/list.json", args, typeof(UserContainer));
                cursor = container.NextCursor;
        ...
        public User Mute(string screenName)
        {
            ...
            return (User)GetOAuthResponce(TwitterAuthenticationMode.UserAuthentication, "POST", "https://api.twitter.com/1.1/mutes/users/create.json", args, typeof(User));
        }
        /// <summary>
        ...
        {
            SortedDictionary<string, string> args = new SortedDictionary<string, string>() { ["screen_name"] = screenName };
            return (User)GetOAuthResponce(TwitterAuthenticationMode.UserAuthentication, "POST", "https://api.twitter.com/1.1/mutes/users/destroy.json", args, typeof(User));
        }
        /// <summary>
